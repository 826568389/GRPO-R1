...
stale_egg_info = Path(__file__).parent / "grpo_r1.egg-info"
if stale_egg_info.exists():
    print(
        (
            "Warning: {} exists.\n\n"
            "If you recently updated grpo_r1, this is expected,\n"
            "but it may prevent grpo_r1 from installing in editable mode.\n\n"
...
setup(
    ...
    license="Apache",
    url="https://github.com/dhcode-cpp/GRPO-R1",
    package_dir={"": "src"},
